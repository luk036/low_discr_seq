...
breathe_projects = {"low_discr_seq": "./doxyoutput/xml"}
breathe_default_project = "low_discr_seq"
...
htmlhelp_basename = 'low_discr_seqdoc'
...
latex_documents = [
  (master_doc, 'low_discr_seq.tex', u'low_discr_seq Documentation',
...
man_pages = [
    (master_doc, 'low_discr_seq', u'low_discr_seq Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'low_discr_seq', u'low_discr_seq Documentation',
   author, 'low_discr_seq', 'One line description of project.',
   'Miscellaneous'),
]
